<div class="row">
    ...
    <div class="col-sm-10 col-xs-12">
        ...
        <form class="dingtalk-login-settings">
            ...
            <div class="form-group">
                <label for="getUserInfoByUnionid">通过Unionid获取用户信息接口地址</label>
                <input type="text" name="getUserInfoByUnionid" title="getUserInfoByUnionid" class="form-control" placeholder="getUserInfoByUnionid URL" />
            </div>
